...
namespace Webstoretest
{
    ...
    {
        //проверим, что метод controller.ProductDetails() //возращает корректную модель

        [Fact]
        public void ProductDetils_Returns_View_With_Correct_Item()
        {
            //Arrange
        ...
        public void Shop_Method_Returns_Correct_View()
        {
            ...
            Xunit.Assert.Equal("TestImage2.jpg",
