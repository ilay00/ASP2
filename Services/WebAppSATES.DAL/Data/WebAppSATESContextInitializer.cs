...
namespace WebAppSATES.Data
{
    public class WebAppSATESContextInitializer
    {
        private readonly WebAppSATESContext _db;
        private readonly UserManager<User> _UserManager;
        private readonly RoleManager<Role> _RoleManager;

        public WebAppSATESContextInitializer(WebAppSATESContext db, UserManager<User> UserManager, RoleManager<Role> RoleManager)
        {
            _db = db;
